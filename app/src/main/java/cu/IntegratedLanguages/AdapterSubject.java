...
class AdapterSubject extends ArrayAdapter<Subject>{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        LinearLayout sentences=(LinearLayout) convertView.findViewById(R.id.sentences);
        LinearLayout exercices=(LinearLayout) convertView.findViewById(R.id.exercise);
        ...
        exercices.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id_subject",subject.getId());
                getContext().startActivity(intent);
            }
        });
